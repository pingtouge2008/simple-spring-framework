...
public class DefaultAdvisorAutoProxyCreator implements InstantiationAwareBeanPostProcessor, BeanFactoryAware {
    ...
    public Object postProcessBeforeInstantiation(Class<?> beanClass, String beanName) throws BeansException {
        ...
        Collection<AspectJExpressionPointcutAdvisor> aspects = beanFactory.getBeansOfType(AspectJExpressionPointcutAdvisor.class).values();

        for (AspectJExpressionPointcutAdvisor aspect : aspects) {
            ...
            advisedSupport.setMethodInterceptor((MethodInterceptor) aspect.getAdvice());
            advisedSupport.setMethodMatcher(aspect.getPointcut().getMethodMatcher());
